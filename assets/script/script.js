...
function downloadCV() {
  ...
  //tempLink.setAttribute('href', '/assets/vendor/CV-Rifai.pdf'); // Gantilah dengan path yang sesuai
  tempLink.setAttribute('download', 'CV-Rifai.pdf'); // Gantilah dengan nama file yang sesuai
...
/* ----- TYPING EFFECT ----- */
 var typingEffect = new Typed(".typedText",{
    strings : ["Programmer","Web Developer","Game Developer","UI/UX Designer"],
    loop : true,
    typeSpeed : 150, 
    backSpeed : 120,
    backDelay : 2000
